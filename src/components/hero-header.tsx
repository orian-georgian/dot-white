...
function HeroHeaderComponent() {
  ...
  return (
    <section
      ...
      className="relative isolate flex min-h-screen w-full items-center overflow-hidden px-3 sm:px-10"
    ...
    >
      ...
      <div className="relative mx-auto w-full max-w-7xl py-8 sm:py-16">
        <div
          className={
            isMobile
              ? "flex flex-col items-center justify-center gap-6 px-2"
              : "grid items-center gap-10 lg:grid-cols-[1.35fr_0.65fr] lg:gap-12"
          }
        >
          <div className={isMobile ? "w-full flex flex-col items-center space-y-5" : "max-w-none space-y-8 lg:space-y-9"}>
            <WordRevealTitle
              id="hero-heading"
              className={
                isMobile
                  ? "text-center text-4xl font-bold leading-tight text-foreground tracking-tight"
                  : "text-balance text-5xl font-semibold leading-[1.02] tracking-tight text-foreground sm:text-6xl md:text-7xl"
              }
              text={headline}
              prefersReducedMotion={!!prefersReducedMotion}
            />
            ...
            <motion.p
              className={
                isMobile
                  ? "mt-2 text-base leading-relaxed text-foreground/80 text-center max-w-xs mx-auto"
                  : "text-base leading-relaxed text-foreground/80 sm:text-lg lg:pr-14"
              }
            ...
            <motion.div
              className={
                isMobile
                  ? "flex flex-col gap-3 pt-4 w-full max-w-xs mx-auto"
              ...
              {isMobile ? (
                <>
                  <Button
                    ...
                    variant="primary"
                    size="md"
                    className="relative w-full justify-center overflow-hidden text-base font-semibold py-3 rounded-lg shadow-sm"
                  >
                  ...
                  <Button
                    ...
                    variant="primary"
                    size="md"
                    className="relative w-full justify-center overflow-hidden border border-foreground/35 !bg-transparent !text-foreground !shadow-none hover:!bg-foreground/[0.08] hover:!shadow-none text-base font-semibold py-3 rounded-lg"
                  >
          ...
          {/* Desktop right-side hero image and bubbles */}
          {!isMobile && (
            <motion.div
